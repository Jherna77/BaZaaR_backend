...
-- Usuarios de prueba
INSERT INTO users (id, email, password, name, surnames, address, city, province, zip_code) VALUES (1, 'masteradmin@bazaar.es', '123456','Administrador','Master','BaZaaR Street, SN','BaZaaR City','BaZaaR Province', 77777);
INSERT INTO users (id, email, password, name, surnames, address, city, province, zip_code) VALUES (2, 'shop1@bazaar.es', '123456','Shop1', 'Shop1Surname', 'BaZaaR Street, SN','BaZaaR City','BaZaaR Province', 77777);
INSERT INTO users (id, email, password, name, surnames, address, city, province, zip_code) VALUES (3, 'shop2@bazaar.es', '123456','Shop2', 'Shop2Surname', 'BaZaaR Street, SN','BaZaaR City','BaZaaR Province', 77777);
INSERT INTO users (id, email, password, name, surnames, address, city, province, zip_code) VALUES (4, 'shop3@bazaar.es', '123456','Shop3', 'Shop3Surname', 'BaZaaR Street, SN','BaZaaR City','BaZaaR Province', 77777);
INSERT INTO users (id, email, password, name, surnames, address, city, province, zip_code) VALUES (5, 'customer1@bazaar.es', '123456','Customer1','Customer1Surname','BaZaaR Street, SN','BaZaaR City','BaZaaR Province', 77777);
INSERT INTO users (id, email, password, name, surnames, address, city, province, zip_code) VALUES (6, 'customer2@bazaar.es', '123456','Customer2','Customer2Surname','BaZaaR Street, SN','BaZaaR City','BaZaaR Province', 77777);
INSERT INTO users (id, email, password, name, surnames, address, city, province, zip_code) VALUES (7, 'customer3@bazaar.es', '123456','Customer3','Customer3Surname','BaZaaR Street, SN','BaZaaR City','BaZaaR Province', 77777);
